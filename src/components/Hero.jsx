    ...
    <section className="w-full bg-white text-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16 py-2 md:py-3 flex flex-col-reverse md:flex-row items-center justify-between gap-4 md:gap-6">
        ...
        >
          ...
          {/* CTA button → navigates to Recommended section */}
          <div className="mt-3">
            <a href="#recommended">
        ...
        {/* -------- Right Section: Hero Banner Image -------- */}
        <motion.div 
        ...
        >
          <img
            src={BannerImage}
            alt="Shopping"
            className="w-[80%] max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl h-auto object-cover"
          />
        </motion.div>
