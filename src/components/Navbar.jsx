    ...
    <nav className="sticky top-0 w-full bg-[#0d99ff] text-white border-b border-white/20 shadow-sm z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3 md:py-4">
        ...
        <form
          ...
          className="hidden md:flex items-center bg-white rounded-full overflow-hidden w-1/2 max-w-lg shadow-sm border border-gray-200"
        >
          <input
            type="text"
            value={query}
        ...
        <div className="flex items-center gap-3 md:gap-4">
          <button className="hidden md:block bg-white text-[#0d99ff] px-4 py-2 rounded-full font-medium hover:bg-gray-100 transition shadow-sm text-sm cursor-pointer">
            Become a Supplier
          </button>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white text-gray-800 rounded-lg shadow-lg border border-gray-300 overflow-hidden z-50">
                <div className="relative">
                  ...
                  <Link
                    to="/orders"
                    className="w-full block text-left px-4 py-2 text-sm hover:bg-gray-100 transition cursor-pointer"
                  >
                    My Orders
                  </Link>
                  <Link
                  ...
                  <button className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 transition cursor-pointer">
                    Login
                  </button>
                  <button className="w-full text-left px-4 py-2 text-sm hover:bg-gray-100 transition cursor-pointer">
                    Register
          ...
          <Link
            to="/cart"
            className="p-2 hover:bg-white/20 rounded-full transition relative cursor-pointer"
          >
          ...
          <button
            ...
            className="md:hidden p-2 hover:bg-white/20 rounded-full transition cursor-pointer"
          >
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-[#0d99ff] border-t border-white/20 px-4 pb-4 space-y-3">
          ...
          <Link
            to="/orders"
            className="w-full block text-white hover:underline text-sm cursor-pointer"
          >
            My Orders
          </Link>
          <Link
